...
public class BActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnNext.setOnClickListener(view -> startActivity(new Intent(BActivity.this, CActivity.class)));


        TextView txtBtnBack = findViewById(R.id.txtBtnBackwards);
        txtBtnBack.setOnClickListener(view -> startActivity(new Intent(BActivity.this, AActivity.class)));
