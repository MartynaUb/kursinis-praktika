...
public class AdapterAPI extends RecyclerView.Adapter<AdapterAPI.EntriesViewHolder> {
    ...
    public AdapterAPI(List<EntryWithActions> entryWithActions, Context context) {
    ...
    @NonNull
    @Override
    public AdapterAPI.EntriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull AdapterAPI.EntriesViewHolder holder, int position) {
