...
import de.h_da.fbi.nzse.thediaryappv2.achievements.Activity;
import de.h_da.fbi.nzse.thediaryappv2.entry.NewActivity;
import de.h_da.fbi.nzse.thediaryappv2.entry.AdapterAPI;
import de.h_da.fbi.nzse.thediaryappv2.entry.EntryWithActions;
import de.h_da.fbi.nzse.thediaryappv2.notifications.ReminderBroadcastAPI;
...
public class HomeScreenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        floatingActionButton.setOnClickListener(view -> startActivity(new Intent(this, NewActivity.class)));
        ...
        recyclerView.setAdapter(new AdapterAPI(entryWithActionsList,this));
    }
    ...
    private void notificationHandler(){
        ...
        Intent intent = new Intent(this, ReminderBroadcastAPI.class);
