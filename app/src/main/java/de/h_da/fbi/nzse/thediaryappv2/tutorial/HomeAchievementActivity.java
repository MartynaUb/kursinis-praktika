...
public class HomeAchievementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnNext.setOnClickListener(view -> startActivity(new Intent(this, HomeEntryActivity.class)));


         //Button navigates back to the last slide

        TextView txtBtnBack = findViewById(R.id.txtBtnBackwards);
        txtBtnBack.setOnClickListener(view -> startActivity(new Intent(this, HomePlusActivity.class)));
    }
