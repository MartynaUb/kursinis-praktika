...
public class ViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtBtn.setOnClickListener(view -> startActivity( new Intent(ViewActivity.this, HomeScreenActivity.class)));
    ...
    private void deleteEntry() {
        RoomDatabaseAPI.databaseExecutor.execute(() -> db.entryDao().delete(entryWithActions.entry));
        Toast.makeText(ViewActivity.this, "Dein Eintrag wurde erfolgreich gelöscht.", Toast.LENGTH_SHORT).show();
        startActivity(new Intent(ViewActivity.this, HomeScreenActivity.class));
    }
}